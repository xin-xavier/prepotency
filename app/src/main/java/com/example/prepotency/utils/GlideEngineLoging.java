...
import static com.example.prepotency.app.api.ConstantPool.SIZE_MULTIPLIER;
import static com.example.prepotency.app.api.ConstantPool._4;
import static com.example.prepotency.app.api.ConstantPool._8;
...
public class GlideEngineLoging  implements ImageEngineLoging {
    ...
    // 上下文判断 Bitmap 中心作物 默认压缩 三级缓存 默认图片 默认圆角
                    ...
                    .into(new BitmapImageViewTarget(imageView) {
                        ...
                        protected void setResource(Bitmap resource) {
                            RoundedBitmapDrawable circularBitmapDrawable =
                                    RoundedBitmapDrawableFactory.
                                            create(context.getResources(), resource);
                            circularBitmapDrawable.setCornerRadius(SizeUtils.dp2px(_4));
                            imageView.setImageDrawable(circularBitmapDrawable);
                        }
                    });
        }else{
