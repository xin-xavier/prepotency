...
class GuideActivity : SimpleActivty() {
    ...
    private val guides = mutableListOf<Int>(R.drawable.guide, R.drawable.guide1, R.drawable.guide2)
    ...
    inner class GuidePagerAdapter(layoutResId: Int, data: MutableList<Int>) :
        ...
        override fun convert(holder: BaseViewHolder, item: Int) {
            GlideEngineLoging.createGlideEngine().loadAsGifImage(context, item, holder.getView(R.id.imageView))
